...
class WantlistServiceTest : FunSpec({
    ...
    beforeEach {
        ...
        wantlistService = WantlistService(mockApiClient, mockCacheService, mockMarketplaceService, mockBatchProcessor)
    }
    ...
    context("getMarketplaceListingsForWants") {
        test("should return empty map when given empty release ID list") {
            ...
            runTest {
                val result = wantlistService.getMarketplaceListingsForWants(emptyList())
        ...
        test("should group listings by seller") {
            ...
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A", price = "$10.00"),
                createTestMarketplaceListing(releaseId = 2L, sellerName = "seller-B", price = "$20.00"),
                createTestMarketplaceListing(releaseId = 3L, sellerName = "seller-A", price = "$15.00")
            )
            ...
            runTest {
                val result = wantlistService.getMarketplaceListingsForWants(releaseIds)
        ...
        test("should handle single seller with multiple listings") {
            val releaseIds = listOf(1L, 2L, 3L)
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "mega-seller", price = "$10.00"),
                createTestMarketplaceListing(releaseId = 2L, sellerName = "mega-seller", price = "$20.00"),
                createTestMarketplaceListing(releaseId = 3L, sellerName = "mega-seller", price = "$30.00")
            )
        ...
        test("should handle mix of releases with and without listings") {
            ...
            // Only releases 1 and 3 have listings
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A"),
                createTestMarketplaceListing(releaseId = 3L, sellerName = "seller-B")
            )
        ...
        test("should handle large number of release IDs (batch processing)") {
            ...
            val listings = releaseIds.map { id ->
                createTestMarketplaceListing(releaseId = id, sellerName = "seller-${id % 10}")
            }
        ...
        test("should handle single release ID") {
            ...
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 42L, sellerName = "solo-seller")
            )
        ...
        test("should handle multiple listings from same seller for same release") {
            ...
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A", price = "$10.00"),
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A", price = "$12.00"),
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A", price = "$15.00")
            )
        ...
        test("should handle sellers with special characters in names") {
            ...
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-ñ-ümlaut"),
                createTestMarketplaceListing(releaseId = 2L, sellerName = "seller-日本語")
            )
        ...
        test("should handle very large number of sellers") {
            ...
            val listings = releaseIds.map { id ->
                createTestMarketplaceListing(releaseId = id, sellerName = "seller-$id")
            }
        ...
        test("should preserve all listing details when grouping by seller") {
            val releaseIds = listOf(1L, 2L)
            val listing1 = createTestMarketplaceListing(
                releaseId = 1L,
                sellerName = "seller-A",
                title = "Album 1",
                price = "$10.00"
            )
            val listing2 = createTestMarketplaceListing(
                releaseId = 2L,
                sellerName = "seller-A",
                title = "Album 2",
                price = "$20.00"
        ...
        test("should handle duplicate release IDs gracefully") {
            ...
            val listings = listOf(
                createTestMarketplaceListing(releaseId = 1L, sellerName = "seller-A"),
                createTestMarketplaceListing(releaseId = 2L, sellerName = "seller-B"),
                createTestMarketplaceListing(releaseId = 3L, sellerName = "seller-C")
            )
...
private fun createTestMarketplaceListing(
