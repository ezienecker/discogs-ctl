package de.ezienecker.core.infrastructure.discogs.client.auth.providers

import de.ezienecker.core.infrastructure.discogs.client.auth.providers.DiscogsAuthProvider.Companion.AUTH_SCHEME_DISCOGS
...
class DiscogsAuthProvider(
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            "de.ezienecker.core.infrastructure.discogs.client.auth.providers"
        )
    )
